...
if("FALSE" STREQUAL "TRUE")
  set(grasp_planning_graspit_SOURCE_PREFIX /home/rrameshwar/JacoTeleoperationHaptics/src/graspit-pkgs/grasp_planning_graspit)
  set(grasp_planning_graspit_DEVEL_PREFIX /home/rrameshwar/JacoTeleoperationHaptics/devel_isolated/grasp_planning_graspit)
  ...
  set(grasp_planning_graspit_INSTALL_PREFIX /home/rrameshwar/JacoTeleoperationHaptics/install_isolated)
...
if(NOT "include;/usr/include/qt4/QtDesigner;/usr/include/qt4/QtDeclarative;/usr/include/qt4/QtScriptTools;/usr/include/qt4/QtDBus;/usr/include/qt4/QtXml;/usr/include/qt4/QtSql;/usr/include/qt4/QtOpenGL;/usr/include/qt4/QtNetwork;/usr/include/qt4/QtXmlPatterns;/usr/include/qt4/QtHelp;/usr/include/qt4/QtUiTools;/usr/include/qt4/QtTest;/usr/include/qt4/QtScript;/usr/include/qt4/QtSvg;/usr/include/qt4/Qt3Support;/usr/include/qt4/QtGui;/usr/include/qt4/QtCore;/usr/share/qt4/mkspecs/default;/usr/include/qt4;/usr/include " STREQUAL " ")
  set(grasp_planning_graspit_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/qt4/QtDesigner;/usr/include/qt4/QtDeclarative;/usr/include/qt4/QtScriptTools;/usr/include/qt4/QtDBus;/usr/include/qt4/QtXml;/usr/include/qt4/QtSql;/usr/include/qt4/QtOpenGL;/usr/include/qt4/QtNetwork;/usr/include/qt4/QtXmlPatterns;/usr/include/qt4/QtHelp;/usr/include/qt4/QtUiTools;/usr/include/qt4/QtTest;/usr/include/qt4/QtScript;/usr/include/qt4/QtSvg;/usr/include/qt4/Qt3Support;/usr/include/qt4/QtGui;/usr/include/qt4/QtCore;/usr/share/qt4/mkspecs/default;/usr/include/qt4;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'grasp_planning_graspit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT grasp_planning_graspit_NUM_DUMMY_TARGETS)
      set(grasp_planning_graspit_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::grasp_planning_graspit::wrapped-linker-option${grasp_planning_graspit_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR grasp_planning_graspit_NUM_DUMMY_TARGETS "${grasp_planning_graspit_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::grasp_planning_graspit::wrapped-linker-option${grasp_planning_graspit_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND grasp_planning_graspit_LIBRARIES "${interface_target_name}")
