...
class GraspActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GraspFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GraspActionFeedback(null);
    ...
    data.feedback = GraspFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GraspActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GraspFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GraspFeedback()
    }
...
module.exports = GraspActionFeedback;
