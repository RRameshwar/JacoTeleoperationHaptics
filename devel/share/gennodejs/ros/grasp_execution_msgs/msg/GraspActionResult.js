...
class GraspActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GraspResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GraspActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GraspResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GraspResult()
    }
...
module.exports = GraspActionResult;
