...
"""autogenerated by genpy from grasp_execution_msgs/GraspControlActionResult.msg. Do not edit."""
import sys
...
class GraspControlActionResult(genpy.Message):
  _md5sum = "093853559dd59dd278f2c060ee8daa7f"
  _type = "grasp_execution_msgs/GraspControlActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','grasp_execution_msgs/GraspControlResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspControlActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = grasp_execution_msgs.msg.GraspControlResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = grasp_execution_msgs.msg.GraspControlResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2iB().pack(_x.result.execution_time.secs, _x.result.execution_time.nsecs, _x.result.success))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.execution_time.secs, _x.result.execution_time.nsecs, _x.result.success,) = _get_struct_2iB().unpack(str[start:end])
