...
"""autogenerated by genpy from grasp_execution_msgs/GraspData.msg. Do not edit."""
import sys
...
class GraspData(genpy.Message):
  _md5sum = "17366bcaaaefb782506d4305e5e6f7b0"
  _type = "grasp_execution_msgs/GraspData"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# An identifier for this particular grasp action
int32 id
...
float64 y
float64 z"""
  __slots__ = ['id','grasp','effector_link_name']
  _slot_types = ['int32','moveit_msgs/Grasp','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspData, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.id is None:
        self.id = 0
      if self.grasp is None:
        self.grasp = moveit_msgs.msg.Grasp()
      if self.effector_link_name is None:
        self.effector_link_name = ''
    else:
      self.id = 0
      self.grasp = moveit_msgs.msg.Grasp()
      self.effector_link_name = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.effector_link_name = str[start:end].decode('utf-8')
      else:
        self.effector_link_name = str[start:end]
      return self
