// Generated by gencpp from file grasp_execution_msgs/GraspAction.msg
// DO NOT EDIT!


#ifndef GRASP_EXECUTION_MSGS_MESSAGE_GRASPACTION_H
#define GRASP_EXECUTION_MSGS_MESSAGE_GRASPACTION_H
...
#include <grasp_execution_msgs/GraspActionGoal.h>
#include <grasp_execution_msgs/GraspActionResult.h>
#include <grasp_execution_msgs/GraspActionFeedback.h>
...
struct GraspAction_
{
  ...
  (void)_alloc;
   ...
   typedef  ::grasp_execution_msgs::GraspActionGoal_<ContainerAllocator>  _action_goal_type;
  _action_goal_type action_goal;

   typedef  ::grasp_execution_msgs::GraspActionResult_<ContainerAllocator>  _action_result_type;
  _action_result_type action_result;

   typedef  ::grasp_execution_msgs::GraspActionFeedback_<ContainerAllocator>  _action_feedback_type;
  ...
  typedef boost::shared_ptr< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> const> ConstPtr;

}; // struct GraspAction_

typedef ::grasp_execution_msgs::GraspAction_<std::allocator<void> > GraspAction;

typedef boost::shared_ptr< ::grasp_execution_msgs::GraspAction > GraspActionPtr;
typedef boost::shared_ptr< ::grasp_execution_msgs::GraspAction const> GraspActionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::grasp_execution_msgs::GraspAction_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::grasp_execution_msgs::GraspAction_<ContainerAllocator1> & lhs, const ::grasp_execution_msgs::GraspAction_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
{
  ...
  static const char* value(const ::grasp_execution_msgs::GraspAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaad6be33fae8318bULL;
  static const uint64_t static_value2 = 0xc8b2a8a06fe45830ULL;
};

template<class ContainerAllocator>
struct DataType< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::grasp_execution_msgs::GraspAction_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::grasp_execution_msgs::GraspAction_<ContainerAllocator>& v)
  {
    s << indent << "action_goal: ";
    s << std::endl;
    Printer< ::grasp_execution_msgs::GraspActionGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.action_goal);
    s << indent << "action_result: ";
    s << std::endl;
    Printer< ::grasp_execution_msgs::GraspActionResult_<ContainerAllocator> >::stream(s, indent + "  ", v.action_result);
    s << indent << "action_feedback: ";
    s << std::endl;
    Printer< ::grasp_execution_msgs::GraspActionFeedback_<ContainerAllocator> >::stream(s, indent + "  ", v.action_feedback);
  }
};
...
#endif // GRASP_EXECUTION_MSGS_MESSAGE_GRASPACTION_H
