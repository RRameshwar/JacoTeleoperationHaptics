...
bool operator==(const ::grasp_planning_graspit_msgs::LoadDatabaseModelRequest_<ContainerAllocator1> & lhs, const ::grasp_planning_graspit_msgs::LoadDatabaseModelRequest_<ContainerAllocator2> & rhs)
{
  return lhs.model_id == rhs.model_id &&
    lhs.model_pose == rhs.model_pose &&
    lhs.clear_other_models == rhs.clear_other_models;
}
...
struct Definition< ::grasp_planning_graspit_msgs::LoadDatabaseModelRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Instructs GraspIt to load a database model and place it at a given location in the world.\n"
